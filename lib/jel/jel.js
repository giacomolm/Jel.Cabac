    ...
    if (typeof define == 'function' && define.amd) define(definition)
			...
			Jel.fn = Jel.prototype = {
				...
				convert: function(baseFile, baseElement, wrapper){					
					...
					console.log(xmlDoc, (new DOMParser()).parseFromString(xhttp.responseText,"text/xml"));				
					...
					if(wrapper){
						...
						//if(el.canvasShapes.at(i).shapes) 
						getXML(xmlDoc, xmlDoc.getElementsByTagName(baseElement)[0], sortedShapes);
					}
